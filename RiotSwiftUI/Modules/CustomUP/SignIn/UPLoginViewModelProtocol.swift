...
//
//    var callback: (@MainActor (UPLoginViewModelResult) -> Void)? { get set }
...
//    /// - Parameter homeserver: The view data for the homeserver. This can be generated using `UPService.Homeserver.viewData`.
//    @MainActor func update(homeserver: AuthenticationHomeserverViewData)
//
//    /// Display an error to the user.
//    /// - Parameter type: The type of error to be displayed.
//    @MainActor func displayError(_ type: UPLoginErrorType)
//}
