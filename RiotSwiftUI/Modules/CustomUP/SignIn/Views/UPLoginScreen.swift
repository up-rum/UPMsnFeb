...
// MARK: Private
    ...
    @ObservedObject var viewModel: UPLoginViewModel.Context
    var body: some View {
//        Color("BgColor")
        NavigationView {
            ZStack {
...
//                    Spacer()
//                    NavigationLink(destination: LoginView( viewModel: viewModel.send(viewAction: .login))) {
...
struct UPLoginScreen_Previews: PreviewProvider {
    static let stateRenderer = MockUPLoginState.stateRenderer
