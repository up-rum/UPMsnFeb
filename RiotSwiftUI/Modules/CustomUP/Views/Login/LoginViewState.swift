...
struct LoginViewState: BindableState, CustomDebugStringConvertible {
    ...
    var bindings: LoginPageBindings
...
//        let page4Title = locale.identifier.hasPrefix("en") ? "Cut the slack from teams." : VectorL10n.onboardingSplashPage4TitleNoPun
        ...
        self.bindings = LoginPageBindings()
    }
}

struct LoginPageBindings {
    var pageIndex = 0
}

enum LoginPageViewAction {
    case register
    case login
    case nextPage
    case previousPage
